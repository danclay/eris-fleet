...
export declare class IPC extends EventEmitter {
    ...
    */
    restartCluster(clusterID: number, hard?: boolean): Promise<Admiral.ClusterCollection | undefined>;
    /**
    ...
    */
    restartService(serviceName: string, hard?: boolean): Promise<Admiral.ServiceCollection | undefined>;
    /**
    ...
    */
    shutdownCluster(clusterID: number, hard?: boolean): Promise<Admiral.ClusterCollection | undefined>;
    /**
    ...
    */
    shutdownService(serviceName: string, hard?: boolean): Promise<Admiral.ServiceCollection | undefined>;
    /**
     * Create a service
     ...
     */
    createService(serviceName: string, servicePath: string): Promise<Admiral.ServiceCollection | undefined>;
    /**
    ...
    */
    reshard(options?: Admiral.ReshardOptions): Promise<void>;
    /**
